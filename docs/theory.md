...
### Як самостійно відкрити наш графік?
Ми інтегрували професійний переглядач `Speedscope` прямо в цю сторінку! Щоб побачити магію кешу на власні очі, зробіть наступне:

1. Завантажте зібраний файл з масивом даних: [👉 Завантажити cache-misses.txt](./cache-misses.txt)
2. Відкрийте наш локальний інструмент-аналізатор: [👉 Відкрити Speedscope](./speedscope/index.html)
3. У великому синьому вікні Speedscope натисніть **"Browse"** та оберіть щойно завантажений файл `cache-misses.txt`.
